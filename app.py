...
if 'rag_system' in st.session_state and st.session_state.rag_system is not None:
    ...
    # Show message when RAG system is not available
    st.info("🔧 Please provide a valid API key to initialize the RAG system.")
    col4, col5 = st.columns(2)
    with col4:
        st.markdown("""
            ### Getting Started:
            1. Enter your Cohere API key in the sidebar
            2. The system will automatically initialize
            3. You can then search documents and add new content
        """)
    with col5:
        st.markdown("""
            ### What you can do with this system:
            - **Search**: Query your knowledge base with natural language
            - **Add Documents**: Upload files or paste text content
            - **Monitor**: Track system performance and document statistics
        """)